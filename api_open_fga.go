	...
	for i := 0; i < maxRetry+1; i++ {
		...
		if localVarHTTPResponse.StatusCode >= 300 {
			...
			if localVarHTTPResponse.StatusCode == 400 || localVarHTTPResponse.StatusCode == 422 {
				newErr := OpenFgaApiValidationError{
					body:               localVarBody,
			...
			if localVarHTTPResponse.StatusCode == 401 || localVarHTTPResponse.StatusCode == 403 {
				newErr := OpenFgaApiAuthenticationError{
					body: localVarBody,
			...
			if localVarHTTPResponse.StatusCode == 404 {
				newErr := OpenFgaApiNotFoundError{
					body:               localVarBody,
					storeId:            a.client.cfg.StoreId,
					endpointCategory:   "Check",
					requestBody:        localVarPostBody,
			...
			if localVarHTTPResponse.StatusCode == 429 {
				...
				newErr := OpenFgaApiRateLimitError{
					body: localVarBody,
			...
			if localVarHTTPResponse.StatusCode >= 500 {
				newErr := OpenFgaApiInternalError{
					body: localVarBody,
 ...
 * @return map[string]interface{}
 */
func (a *OpenFgaApiService) WriteAssertionsExecute(r ApiWriteAssertionsRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var maxRetry int
	var minWaitInMs int
