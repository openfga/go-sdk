...
func main() {
    ...
    body := *openapiclient.NewListUsersRequest(*openapiclient.NewObject("document", "Id_example"), "reader", []openapiclient.ListUsersFilter{*openapiclient.NewListUsersFilter("group")}) // ListUsersRequest | 
