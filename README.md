...
![Release](https://img.shields.io/github/v/release/openfga/go-sdk?sort=semver&color=green)
...
apiClient := openfga.NewAPIClient(configuration)
stores, response, err := openFga.ListStores(context.Background()).Execute();
...
[API Documentation](https://openfga.dev/api#/Tuples/Check)
...
[API Documentation](https://openfga.dev/api#/Tuples/Write)
...
[API Documentation](https://openfga.dev/api#/Debugging/Expand)
...
[API Documentation](https://openfga.dev/api#/Tuples/Read)
...
[API Documentation](https://openfga.dev/api#/Tuples/ReadChanges)
